...
import { MapPin, Phone, Mail, Clock, Send } from "lucide-react"; // İkonlar

export const metadata = {
  title: "İletişim | Emlak Projesi",
...
export default function IletisimPage() {
  return (
    <main className="w-full bg-white min-h-screen pb-20">
      ...
      {/* 1. HEADER (Aynı yapıyı koruyoruz) */}
      <Breadcrumb 
        title="İletişim" 
      ...
      <div className="w-full max-w-[1280px] mx-auto px-4 mt-16 md:mt-24 flex flex-col lg:flex-row gap-12 lg:gap-20">
        ...
        {/* --- SOL TARA: İLETİŞİM BİLGİLERİ & HARİTA --- */}
        ...
        <div className="flex-1">
          <div className="bg-white rounded-[2rem] shadow-2xl p-8 md:p-12 border border-gray-100">
            ...
            <form className="flex flex-col gap-6">
              ...
              {/* Gönder Butonu */}
              <button 
                type="button" // Form submit işlemi olmadığı için button dedik
